...
const FrenchMontana = () => {
  return (
    <section className="bg-white py-12 px-4 min-h-screen flex items-center justify-center font-sans">
      ...
      */}
      <div className="max-w-300 w-full min-h-[80vh] bg-[#1A1A1A] rounded-2xl flex flex-col md:flex-row items-center justify-between p-10 md:p-20 gap-12 md:gap-24 shadow-2xl relative overflow-hidden">
        ...
        <div className="max-w-300 w-full flex flex-col md:flex-row items-center justify-between gap-12 md:gap-24 relative overflow-hidden">
            {/* Image Column 
            - w-full md:w-1/2: Generous width
